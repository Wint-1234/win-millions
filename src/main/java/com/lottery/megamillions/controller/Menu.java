...
public class Menu {
  ...
  public Menu() {
    ...
    public int predictNumbers () {
      ...
      System.out.println(
          "1. Predict with custom values."); // TODO: 10/5/2022 change to just predict
      System.out.println(CLOSE_PROGRAM_MESSAGE);
    ...
    {// TODO: 10/5/2022 going to have to -1 to month input for method call
...
//    System.out.println(userCart);
      ...
      if (userInput == 1) {
        ...
        String invalidMessageMonth = String.format(standardInputError, EARLIEST_MONTH,
            LATEST_MONTH);
